...
Процедура ОбновитьДанныеКВыгрузкеНаСервере()
	...
	Для Каждого СтрокаТаблицы из ТаблицаИспользованныхСсылочныхОбъектов Цикл
		...
		ПолучитьОбъектыРекурсивно(НоваяСтрока.Ссылка, МассивОбъектов, ТипыДокументовВыгружаемыхСДвижениями, 0, 2); 
...
&НаСервере
Процедура ПолучитьОбъектыРекурсивно(СсылкаНаОбъект, МассивОбъектов, ТипыДокументовВыгружаемыхСДвижениями, ТекущийУровеньРекурсии, МаксУровеньРекурсии) 
	...
	Если ЭтоДокумент Или ЭтоСправочник Тогда
		...
		Для каждого РеквизитОбъекта из МетаданныеСсылки.Реквизиты Цикл
			...
			ПолучитьОбъектыРекурсивно(ЗначениеРеквизита, МассивОбъектов, ТипыДокументовВыгружаемыхСДвижениями, ТекущийУровеньРекурсии + 1, МаксУровеньРекурсии);
